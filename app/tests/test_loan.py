...
def test_solicitar_prestamo(driver):
    ...
    input_email.send_keys('prueba6@gmail.com')
    time.sleep(2)
    ...
    btn_solicitar_loan = driver.fid_element(By.CLASS_NAME, 'primerlink')
    ...
    return driver.current_url == "http://127.0.0.1:5000/info_préstamo/"